...
### Workflow Skills (7) — End-to-End Processes
...
|-------|--------------|----------|
| **[company-intel](skills/company-intel/SKILL.md)** | Research and synthesize enterprises, industries, and niches through a PM lens — three modes: Industry, Company, and Prompt Architect — organized across seven research lenses including strategic signals (patents, hiring, leadership) | Per session |
