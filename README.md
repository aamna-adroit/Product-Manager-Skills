...
║   ╚═╝     ╚═╝     ╚═╝    ╚══════╝╚═╝  ╚═╝╚═╝╚══════╝╚══════╝╚══════╝
║                                                                    ║
║   56 battle-tested skills + 6 command workflows                    ║
...
**56 battle-tested PM frameworks, ready for Claude, Codex, ChatGPT, and any agent that can read structured knowledge.**
...
| All skills | [`99-all-skills-pack.zip`](https://github.com/deanpeters/Product-Manager-Skills/releases/latest/download/99-all-skills-pack.zip) | All 56 skills |
...
**Full catalog:** [catalog/INDEX.md](catalog/README.md) — all 56 skills with descriptions, or browse `skills/` directly.
